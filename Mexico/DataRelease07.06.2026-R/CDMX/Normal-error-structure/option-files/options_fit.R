...
options_fit <- function() {
  ...
  # Dataset Properties
  # =========================================================================
  cadfilename1 <- "CIUDAD_DE_MEXICO_2025-08-04_2026-06-29-trimmed"   # Data file name (without .txt)
  ...
  # =========================================================================
  method1        <- 0     # 0=LSQ, 1=MLE Poisson, 3=MLE NB(mean+alpha*mean),
                          # 4=MLE NB(mean+alpha*mean^2), 5=MLE NB(mean+alpha*mean^d)
  dist1          <- 0     # Error structure: 0=Normal, 1=Poisson, 2=NB(factor*mean),
  ...
  # =========================================================================
  windowsize1 <- 29       # Calibration window size (number of data points)
