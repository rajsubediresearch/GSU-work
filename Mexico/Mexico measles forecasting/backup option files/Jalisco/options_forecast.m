...
cadfilename1 = 'jalisco_weekly-trimmed'; % Name of the time-series data file
...
flag1 = GRM;         % Selected growth model: Logistic Model (GLM)
model_name1 = 'GRM'; % Name of the selected model
...
getperformance = 0;    % Enable forecasting performance metrics (1 = yes, 0 = no)
forecastingperiod = 6; % Forecast horizon: Number of time units ahead
...
windowsize1 = 37; % Size of the rolling window (e.g., 10 time units)
