...
options_forecast <- function() {
  ...
  # Dataset Properties
  # =========================================================================
  cadfilename1 <- "JALISCO_2025-08-18_2026-06-15-trimmed"   # Data file name (without .txt)
  ...
  # =========================================================================
  method1        <- 0     # see top for details
  dist1          <- 0     # see top for details
  ...
  forecastingperiod <- 1  # n-week ahead forecast horizon

  # =========================================================================
  # Rolling Window Parameters
  # =========================================================================
  windowsize1 <- 40       # Calibration window size
