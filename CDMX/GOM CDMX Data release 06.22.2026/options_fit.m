...
cadfilename1 = 'CIUDAD_DE_MEXICO_2025-08-04_2026-06-15-trimmed'; % Name of the data file containing the time-series data.
...
flag1 = GOM;         % Selected growth model: Logistic Model (GLM).
model_name1 = 'GOM'; % Name of the selected model.
...
windowsize1 = 29; % Size of the rolling window (e.g., 20 days).
